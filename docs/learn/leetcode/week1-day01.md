...
交不出下面 3 样，不算完成 Day 1（站内可勾选）：

- [ ] **LeetCode 提交通过**（Java，`Solution` 类）
- [ ] 写好笔记：`D:/learn-agent-lab/notes/lc/day-01.md`
- [ ] 站点打卡：[/learn/leetcode](/learn/leetcode) → 备注 `217`
...
- [ ] 读题澄清 5 条心里有数
- [ ] 能口述暴力 O(n²) → 目标 O(n)/O(n)
- [ ] Java HashSet 解法本地/站点通过
- [ ] 边界用例表至少跑完前 4 行
- [ ] `day-01.md` 写完（模式名 + 复杂度 + 坑点）
- [ ] `/learn/leetcode` 点亮今日，备注 `217`
